...
[![GitHub Release](https://img.shields.io/github/v/release/clbiggs/workload-restarter)](https://github.com/clbiggs/workload-restarter/releases)
[![Go Reference](https://pkg.go.dev/badge/github.com/clbiggs/workload-restarter.svg)](https://pkg.go.dev/github.com/clbiggs/workload-restarter)
[![go.mod](https://img.shields.io/github/go-mod/go-version/clbiggs/workload-restarter)](go.mod)
[![LICENSE](https://img.shields.io/github/license/clbiggs/workload-restarter)](LICENSE)
[![Build Status](https://img.shields.io/github/actions/workflow/status/clbiggs/workload-restarter/build.yml?branch=main)](https://github.com/clbiggs/workload-restarter/actions?query=workflow%3Abuild+branch%3Amain)
[![Go Report Card](https://goreportcard.com/badge/github.com/clbiggs/workload-restarter)](https://goreportcard.com/report/github.com/clbiggs/workload-restarter)
[![Codecov](https://codecov.io/gh/clbiggs/workload-restarter/branch/main/graph/badge.svg)](https://codecov.io/gh/clbiggs/workload-restarter)
...
1. Replace all occurrences of `clbiggs/workload-restarter` to `your_org/repo_name` in all files.
